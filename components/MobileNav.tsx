        ...
        <Sheet>
            ...
            >
                <Image 
                    ...
                    height={34} 
                />
                <h1 className='text-2xl font-ibm-plex-serif font-bold text-black-1'>Horizon</h1> 
            </Link> 
            <div className='mobilenav-sheet text-black'>
                <SheetClose asChild>
                                            ...
                                            <SheetClose asChild key={item.label}>
                                                <Link 
                                                    ...
                                                    {'bg-bankGradient':isActive})} >
                                                        ...
                                                        <p className={cn('text-base font-semibold text-black-2',{
                                                            'text-white': isActive
                                                        })}>    
                                                        {item.label} 
                                                        </p>
