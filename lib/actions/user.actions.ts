...
export const exchangePublicToken = async ({
  ...
  try {
    ...
    // Create Funding Source URL for account using Dowlla customer ID,processor ID and bank name
    ...
    console.log('error occoured when creating exchangePublicToken =>', error);
    return null;
  }
};
